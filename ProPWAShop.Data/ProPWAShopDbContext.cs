namespace PWAShop.Data
{
    ...
    public class ProPWAShopDbContext : IdentityDbContext<ProPWAShopUser, ProPWAShopRole, string>
    {
        public ProPWAShopDbContext(DbContextOptions<ProPWAShopDbContext> options)
            : base(options)
        {
        }
